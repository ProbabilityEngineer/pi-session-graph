...
function dotGraph(graph: Graph, current?: string) {
	const lines = [
...
async function dotWriteLines(cwd: string, graph: Graph, current?: string, options: { svg?: boolean } = {}) {
...
async function writeDotFiles(cwd: string, graph: Graph, current?: string, options: { svg?: boolean } = {}) {
